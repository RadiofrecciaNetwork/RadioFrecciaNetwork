(function ($) {
     "use strict";
     $("div.repro15").append(
         '<div class="blur"></div><div class="mainsctn"><div class="frnt"><div class="atwrk"></div><div class="plbtn plystp icon-play2 fal fa-play-circle"></div><div class="ttl" data-text=""></div><div class="arst" data-text="RadioFrecciaNetwork"></div><div class="itns icon-appless fab fa-apple"><a href="" target="_blank" title="iTunes"></a></div> <div class="vlm icon-volume-100 fal fa-volume-up"><div class="pnlVol" style="display:none"><input class="volsl" type="range" min="0" max="100" value="100"></div></div><div class="shr icon-shr2 fal fa-share-alt"><div class="pnl" style="display:none"><div class="fb icon-fb fab fa-facebook-f"><a href="" target="_blank" title="Share on Facebook"></a></div><div class="tw icon-tw2 fab fa-twitter"><a href="" target="_blank" title="Share on Twitter"></a></div><div class="emil icon-envelop fal fa-envelop"></div></div></div><div class="timg">00:00</div><div class="mnu icon-menu1 fal fa-menu"></div></div><div class="bck fal fa-times-circle" style="display:none"><div class="rinfo" fal fa-info><div class="radnme"><span class="icon-radio-tw2 fal fa-microphone"></span><a target="_blank" href="" title="Visit Website"></a></div></div><div class="rhis"><ul></ul></div><div class="mnu"></div></div></div>').attr("data-tag");

     $.fn.repro15 = function (options) {
         var settings = $.extend({
             ...
             mount_point: "",
             cors_proxy: "https://mexiserver.herokuapp.com/?q=",
             stream_id: 1,
             streampath: "/stream?icy=https",
             default_image: "https://i.postimg.cc/mDXkw7h2/image.png",
             blurriness: "",
             autoplay: true,
             src: "",
             itunes: true,
         ...
         function playManagement() {
             if (audio.paused) {
                 ...
                 $(".repro15", thisObj).removeClass("nakhon ");
             } else {
                 audio.pause();

                 $(thisObj).addClass("nakhon");
                 $(".repro15", thisObj).removeClass("bekhon");
             }
             ...
             $.getJSON(url, function (data) {
                 for (var i = 0; i < data.length; i++) {
                     ...
                     $(".rhis ul", thisObj).append(
                         "<li class='list' id='row" + rowNum + "'>" + "<div class='hnum listNum'><span>" + listVal + "</span></div>" + "<div class='hnme'>" + titleTEMP + " - " + artistTEMP + "</div>" + "</li>"
                     );
                 }
             });
         }
             ...
             setTimeout(function () {
                 if (data.nexttitle !== undefined) {
                     ...
                     $(".rhis ul li.list#row0", thisObj).before(
                         "<li class='list' id='row" + "NEXT" + "'>" + "<div class='hnum listNum nxttrack'><span>" + "NEXT" + "</span></div>" + "<div class='hnme'>" + titleTEMP + " - " + artistTEMP + "</div>" + "</li>"
                     );
                 }
         ...
         function setFBShareAttr(siteURL) {
             var url = "https://www.facebook.com/" + encodeURIComponent(siteURL);
         ...
         function mixture(artist, title) {
             ...
             (async () => {
                 let image, data = await $.getJSON(iTunessearchArtist),
                     link;
